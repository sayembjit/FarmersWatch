...
public class Crop {
    ...
    public Crop(Long id, String cropName, String growthRequirements, String diseaseSusceptibility) {
        this.id = id;
        this.cropName = cropName;
        this.growthRequirements = growthRequirements;
        this.diseaseSusceptibility = diseaseSusceptibility;
    ...
    public Crop(String cropName, String growthRequirements, String diseaseSusceptibility) {
        this.cropName = cropName;
        this.growthRequirements = growthRequirements;
        this.diseaseSusceptibility = diseaseSusceptibility;
        this.fields = new HashSet<>();
